...
import {
  Leaf, Shield, Droplets, Star, ChevronRight, CheckCircle,
  Quote, ArrowRight, Award, Users, Clock, ThumbsUp, BadgeCheck,
} from "lucide-react";
  ...
  const benefits = [
    {
      ...
      description:
        "Efektif mengatasi penyakit kulit tanpa efek samping berbahaya. Cocok untuk semua jenis kulit.",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Kesuburan Tanduk Domba",
      description:
        "Membantu mempercepat pertumbuhan, memperindah dan meningkatkan kekuatan pada tanduk domba.",
    },
    {
      icon: <Leaf className="w-6 h-6" />,
      title: "100% Alami",
      description:
        "Tanpa bahan kimia berbahaya, murni diekstrak dari alam Indonesia. Aman digunakan setiap hari.",
    },
  ];
  ...
  const features = [
    {
      ...
      image: Eksim,
      description:
        "Minyak biawak kaya akan asam lemak esensial yang membantu regenerasi sel kulit, mengatasi kulit kering, eksim, dan menjaga elastisitas kulit Anda. Penggunaan rutin akan membuat kulit lebih sehat, lembab, dan bercahaya.",
    ...
    },
    {
      ...
      image: Gatal,
      description:
        "Kandungan anti-inflamasi alami membantu meredakan nyeri pada persendian dan otot yang lelah setelah aktivitas berat. Cocok untuk penderita rematik dan nyeri sendi kronis.",
    ...
    },
    {
      ...
      image: Koreng,
      description:
        "Nutrisi lengkap untuk rambut sehat, mengatasi kerontokan, ketombe, dan membuat rambut lebih kuat serta berkilau. Menembus hingga ke akar rambut untuk hasil maksimal.",
  ...
  const testimonials = [
    {
      name: "izalachil",
      quote:
        "Hasil memuaskan ini asli budug kurap bersih......Sudah d coba bukan kaleng kaleng makasih minyaka BAYAWAK...super..Bersih",
      rating: 5,
    },
    {
      name: "c8e8hj4j8m",
  ...
  return (
    <AppLayout>
      <div className="w-full bg-white">
        ...
        >
          <div className="container px-16 pt-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
              <motion.div
                variants={container}
                className="lg:w-1/2 text-center lg:text-left space-y-4 p-6"
              >
                <motion.h1
                  variants={fadeUp}
                  className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-r from-[#FC9150] via-[#FF6100] to-[#FC9150] text-transparent bg-clip-text"
                >
                  Minyak Biawak
                  <span className="font-bold bg-gradient-to-r from-[#80CC28] via-green-600 to-[#80CC28] text-transparent bg-clip-text block mt-2">
                    Asli Indonesia
                  </span>
                </motion.h1>
                ...
                >
                  Dapatkan manfaat terbaik dengan minyak biawak asli untuk kesehatan kulit, mengobati
                  koreng dan luka bakar atau meningkatkan kesuburan tanduk domba serta essen mancing.
                </motion.p>

                <motion.div
                  variants={fadeUp}
                  className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start p-2"
                >
                  <Button
                ...
                >
                  {["100% Kemurnian", "Promo Ekstra", "COD Available"].map((label) => (
        ...
        {/* ===== FEATURES TAB ===== */}
        <motion.section className="py-16 lg:py-24 bg-gray-50" {...sectionProps}>
          <div className="container mx-auto px-6">
            <motion.div variants={fadeUp} className="text-center mb-12 space-y-2">
            ...
            <div className="max-w-5xl mx-auto">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-white p-8 lg:p-12 rounded-3xl shadow-lg border border-gray-100"
                >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
                        {features[activeTab].points.map((point, idx) => (
                          <motion.div
                            ...
                            className="flex items-center gap-3 bg-[#80CC28] px-4 py-3 rounded-xl"
                          >
        ...
        {/* ===== QUALITY ASSURANCE ===== */}
        <motion.section
          className="py-16 lg:py-24 bg-gradient-to-r from-[#80CC28] via-green-600 to-[#80CC28]"
          {...sectionProps}
        >
          <div className="container mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              <motion.div variants={container} className="lg:w-3/5 text-white space-y-6">
                <motion.span
                  variants={fadeUp}
                  className="text-green-200 font-semibold text-sm uppercase tracking-wider"
                >
                  Jaminan Kualitas
                </motion.span>
                ...
                <motion.p variants={fadeUp} className="text-green-100 text-base lg:text-lg leading-relaxed">
                  Setiap botol minyak biawak kami diproduksi dengan standar kualitas tinggi. Kami
                  memastikan kemurnian dan keaslian produk dari proses ekstraksi hingga pengemasan.
                  Diproduksi dengan teknologi modern namun tetap menjaga kearifan lokal.
                </motion.p>

                <motion.div
                  variants={container}
                  className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 pt-4"
                >
              ...
              <motion.div variants={fadeIn} className="lg:w-2/5 flex justify-center">
                <div className="w-72 h-72 lg:w-full lg:h-full rounded-3xl flex items-center justify-center relative overflow-hidden">
                  <div className="flex flex-col items-center gap-4 text-center text-white relative z-10">
                    <img src={Photo7} className="w-full h-full mx-auto object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent" />
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-10">
                      <Badge
                        variant="secondary"
                        className="flex items-center text-[#FF6100] font-semibold gap-1"
                      >
        ...
        {/* ===== TESTIMONIALS ===== */}
        <motion.section className="py-16 lg:py-20 bg-white" {...sectionProps}>
          <div className="container mx-auto px-6">
            <motion.div variants={fadeUp} className="text-center mb-12 lg:mb-16 space-y-3">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
        ...
        {/* ===== CTA BANNER ===== */}
        <motion.section className="py-16 lg:py-4" {...sectionProps}>
          <div className="container mx-auto px-2">
            <div className="bg-gradient-to-r from-[#80CC28] via-green-600 to-[#80CC28] rounded-3xl p-12 lg:p-16 text-center text-white relative overflow-hidden">
              ...
              >
                ...
                <motion.p
                  variants={fadeUp}
                  className="text-green-100 max-w-2xl mx-auto text-base lg:text-lg"
                >
                  Pesan sekarang dan dapatkan diskon spesial 20% untuk pembelian pertama Anda. Gratis
                ...
                <motion.div variants={fadeUp}>
                  <Button
                    onClick={() => {
                      window.open(
                        "https://shopee.co.id/Minyak-Biawak-Asli-Menyembuhkan-Gatal-gatal-Alergi-Eksim-Esen-Memancing-Minyak-Tanduk-i.1380118779.27464620647"
                      );
                    }}
                    className="inline-flex items-center gap-3 bg-white text-green-600 hover:bg-gray-100 px-10 lg:px-12 py-4 lg:py-5 rounded-xl text-base lg:text-lg font-bold shadow-xl transition-all duration-300 hover:scale-105"
                  >
